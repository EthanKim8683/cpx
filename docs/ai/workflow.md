...
AI agents can be helpful when working on cpx. This document describes how to work in this repo.
...
2. Post a summary as a reply on the GitHub-synced comment thread.
3. Respond in conversation and post that response on the same synced thread.
